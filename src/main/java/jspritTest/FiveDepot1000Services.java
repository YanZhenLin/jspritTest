...
public class FiveDepot1000Services {
	...
	public static void main(String... args ){
        ...
        VehicleGenerator vehicleGenerator = new VehicleGenerator(vrpBuilder, "input/vehicleConfig/5Depot.properties");
        vehicleGenerator.generate();
        vrpBuilder.setFleetSize(FleetSize.FINITE); //finite vehicles
        VehicleRoutingProblem vrp = vrpBuilder.build();
        VehicleRoutingAlgorithm vra = Jsprit.Builder.newInstance(vrp).setProperty(Jsprit.Parameter.THREADS, noThreads).buildAlgorithm();
        ...
        File solutionFile = new File("output/PrintedSolutions/"+serviceFileName+"Solution5Depots.txt");
        try {
